...
reg.setFileNames('pe_condiff_deconvolution_updatedClusterStat_saccCorr_uraiParams_RB', 'perm_pe_condiff_deconvolution_updatedClusterStat_saccCorr_uraiParams_RB', '', '');
...
pupil_dir = fullfile(desiredPath, 'data', 'GB data two pipelines', 'pupil', filesep, 'alternate pipeline', filesep, 'pupil signal', filesep, 'non-baseline corrected saccade correction and urai params');
...
reg.setFileNames('pe_condiff_deconvolution_nonBaselineCorrected_saccCorr_uraiParams', 'perm_pe_condiff_deconvolution_nonBaselineCorrected_saccCorr_uraiParams', '', '');
...
reg.setFileNames('pe_condiff2bins_deconv_saccCorr_uraiParams', 'perm_pe_condiff2bins_deconv_saccCorr_uraiParams', '', '');
