...
pupil_dir = fullfile(desiredPath, 'data', 'GB data two pipelines', 'pupil', filesep, 'alternate pipeline', filesep, 'pupil signal', filesep, 'fb saccade correction');
...
reg.setFileNames('pe_condiff_deconvolution_updatedClusterStat_saccCorr', 'perm_pe_condiff_deconvolution_updatedClusterStat_saccCorr', '', '');
...
pupil_dir = fullfile(desiredPath, 'data', 'GB data two pipelines', 'pupil', filesep, 'alternate pipeline', filesep, 'pupil signal', filesep, 'non-baseline corrected saccade correction');
...
reg.setFileNames('pe_condiff_deconvolution_nonBaselineCorrected_saccCorr', 'perm_pe_condiff_deconvolution_nonBaselineCorrected_saccCorr', '', '');
...
reg.setFileNames('pe_condiff_regressedRT_deconvolution_saccCorr', 'perm_pe_condiff_regressedRT_deconvolution_saccCorr', '', '');
...
reg.setFileNames('pe_condiff2bins_deconv_saccCorr', 'perm_pe_condiff2bins_deconv_saccCorr', '', '');
