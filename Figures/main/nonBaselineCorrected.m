...
data_alt = importdata('full_trial non-baseline corrected.mat');
...
hold on
text(145,5100,"Response","FontSize",6,"FontName",'Arial',"BackgroundColor",[222, 228, 233]./255)
text(375,5100,"Feedback","FontSize",6,"FontName",'Arial',"BackgroundColor",[222, 228, 233]./255)
...
trial_all = importdata(strcat(desiredPath, filesep, "data", filesep, "GB data two pipelines", filesep, "pupil", filesep, "descriptive", filesep, "full_trial non-baseline corrected.mat")); % add PE bin curves
...
text(145,5800,"Response","FontSize",6,"FontName",'Arial',"BackgroundColor",[222, 228, 233]./255)
text(375,5800,"Feedback","FontSize",6,"FontName",'Arial',"BackgroundColor",[222, 228, 233]./255)
