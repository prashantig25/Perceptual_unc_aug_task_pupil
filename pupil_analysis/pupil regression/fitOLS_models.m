...
reg.setPaths(behv_dir, pupil_dir, xgaze_dir, ygaze_dir, save_dir);
...
xgaze_dir = fullfile(desiredPath, 'data', 'GB data two pipelines', 'pupil', 'pupil signal', 'x-gaze linear int');
ygaze_dir = fullfile(desiredPath, 'data', 'GB data two pipelines', 'pupil', 'pupil signal', 'y-gaze linear int');
save_dir  = fullfile(desiredPath, 'data', 'GB data two pipelines', 'pupil', 'regression', 'control analyses for supplement');
if ~exist(save_dir, 'dir'), mkdir(save_dir); end
dirs = {
    'pupil_dir',  pupil_dir;
    'xgaze_dir',  xgaze_dir;
