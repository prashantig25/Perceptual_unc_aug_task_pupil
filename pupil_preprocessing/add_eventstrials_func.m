function add_eventstrials_func(subj_ids, num_sess, preproc_dir, save_dir, save_dirASC, behv_dir, prev_num_trials, num_trials_sess)
...
%   num_sess         - array of number of sessions per subject
%   preproc_dir      - directory where preprocessed pupil .xlsx files are stored
%   save_dir         - directory where output files will be saved
%   save_dirASC      - directory where asc2dat converted .mat files are stored
%   behv_dir         - directory to get behavioral data
%   prev_num_trials  - number of trials from previous blocks
