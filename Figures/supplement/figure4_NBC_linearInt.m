...
betas = importdata(strcat(desiredPath, filesep, "data", filesep, "GB data two pipelines", filesep, "pupil", filesep, "regression", filesep, "control analyses for revisions", filesep,"pe_condiff_mathot_nonBaselineCorrected_linearInt.mat")); % add PE bin curves
...
posterior = importdata(strcat(desiredPath, filesep, "data", filesep, "GB data two pipelines", filesep, "pupil", filesep,"regression",filesep,"main",filesep,"BSweightedPE_interactions_nonBaselineCorrected_linearInt.mat"));
...
print(fig, 'regression_pupil_nonBaselineCorrected_linearInt1.png', '-dpng', '-r600') 