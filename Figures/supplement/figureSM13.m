% Multiverse plot with standardized values for uncertainty-weighted PE coefficient
...
% Create plot
multiversePlot('pe_condiff', width_cm, height_cm)
...
style.FontMode = 'none'; 
hgexport(fig, 'Figures/PDF_Versions/Figure_SM13.pdf', style);
