...
ylabel('Absolute PE coefficients','FontWeight','normal','FontName',fontname,'FontSize',fontsize)
...
text(0.2, 0.028, 'Significant threshold for two-tailed test', 'FontSize', 7, 'VerticalAlignment', 'middle');
text(0.2, 0.053, 'Significant threshold for one-tailed test', 'FontSize', 7, 'VerticalAlignment', 'middle');
