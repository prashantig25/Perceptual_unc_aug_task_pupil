...
reg_het3.setPaths(behv_dir, ...
    fullfile(desiredPath, 'data', 'GB data two pipelines', 'pupil', 'alternate pipeline', 'pupil signal', 'fb saccade inconsistency check PG'), ...
    xgaze_dir, ygaze_dir, base_dir, het_save_dir);
...
safe_saveall(fullfile(het_save_dir, 'param_estimates_hetero_noZeroPE_deconvolution_inconsistencyCheckPG.mat'), reg_het3.betas_struct);
safe_saveall(fullfile(het_save_dir, 'negLL_hetero_noZeroPE_deconvolution_inconsistencyCheckPG.mat'),          reg_het3.negLL_values);
