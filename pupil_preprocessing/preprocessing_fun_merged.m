...
%   noFiltering: apply no filtering on the pupil data (in line with R2's recommendations)
...
for s = 1:num_subs
    ...
    for ss = 1:num_sess(s)
        ...
        if noFiltering == 0
            ...
            sacc_response = sacc_response - mean(sacc_response(1)); % note - PG updated this
        ...
        % STEP 8: SAVE - yes
        filename = strcat(savedir,filesep,subj_ids{s},'_main',num2str(ss),'_preprocessed.xlsx');
